...
<nav class="navbar navbar-expand-lg navbar-dark primary-color" id="navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class="container">
    <iframe width="100%" height="100%" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/playe r/?url=https%3A//api.soundcloud.com/playlists/514227969&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
    </div>
</body>
